...
const Body = () => {
    ...
    const [colorTracing, setColorTracing] = useState(false)
                ...
                <div className="container mx-auto pb-6 flex flex-col" ref={gameRef} style={{height}}>
                    <div className="flex flex-col md:flex-row flex-1">
                        <div className="border b-1 border-x-0 md:border-x-1 border-black h-[50%] md:h-[100%] w-full md:w-1/2">
                            <Draw setSvgData={setSvgData} colorTracing={colorTracing} resetVersion={resetVersion} />
                        </div>
                    ...
                    <Controls reset={reset} colorTracing={colorTracing} setColorTracing={setColorTracing} setDamping={updateDamping} />
                </div>
